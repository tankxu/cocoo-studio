...
const ideology = [
  {
    name: "Pure 纯净",
    descCN: "面向企业的产品体验尤其需要简洁性，每个用户都应当感受到简单清晰的流程和协同工作的便利性，这需要从品牌到界面的整体规划和重视，也需要每个参与产品设计的成员对“纯净”理念的深入理解和持续坚持。",
  ...
  {
    name: "Dynamic 动态",
    descCN: "面对不同客户的多样化需求，以及同一产品在不同环境下的体验差异，产品和体验设计应当动态化适应绝大多数场景，这需要充分关注用户即刻产生的体验反馈，体验或服务框架的扩展性，以及不同场景切换时的体验一致性，才能让功能服务更加强大，印象更加统一，产品体验更加健康。",
  ...
  {
    name: "Thinking 思考",
    descCN: "以客户为中心的企业级产品体验设计，应当首先考虑客户实际所处的体验环境，包括且不限于企业结构，企业文化，预算成本，售后服务，以及固有的体验资产，品牌印象等，这些因素要求CODING产品服务需要更加灵活，更加具备客户理解力，能够主动为客户思考，增加产品和服务的体验“引力”。",
              ...
              {ideology.map((item) => (
                    <div className="lg:flex justify-between">
                      <div className="max-w-3xl mr-8">
                        <h3 className="mt-2 text-3xl font-extrabold text-gray-900 tracking-tight sm:text-4xl">{item.name}</h3>
                        <p>{item.descCN}</p>
                        <p>{item.descEN}</p>
                      </div>
