  ...
  return (
    ...
    >
      <div className="flex flex-col w-full mt-20 lg:mt-6 lg:w-auto lg:flex-row lg:absolute">
        ...
        <p
          className={`font-light uppercase opacity-10 mt-2 text-3xl lg:text-3xl lg:mt-0 ${homeSectionTitleEn}`}
        >
          {section.titleEN}
        </p>
      </div>
      ...
      <Dialog as="div" className="fixed z-10 inset-0" onClose={onClose}>
        <div className="flex overflow-hidden">
          ...
          >
            ...
            >
              <XIcon
                className="h-6 w-6 transition duration-300 ease-in-out group-hover:rotate-90"
                aria-hidden="true"
              />
            </button>
          </Transition.Child>
            ...
            <div className=" pt-36 pb-40 mx-auto max-w-7xl px-4 sm:px-6 lg:px-32 text-center">
              <div className="text-base text-brand-blue3">
                ...
                <p className="mt-8">
                  ...
                  It can adapt to the user’s work scene and can also think for
                  the user. It fully reflects the value of each user’s work,
                  that is, the three cores of "pure, dynamic, and thinking". The
                  experience goal pursued by the concept. Under such a goal,
                  whether it is product level, controls and elements, brand
                  identity, or experience architecture, it is necessary to
                  "design around the job role of enterprise customers" and shape
                  the aesthetics of cloud work to "sustain Enhance the daily
                  work experience of each user".
                </p>
              </div>
            </div>
          </div>
